...
const Navbar = () => {
    const navLink = <>
        <HashLink smooth to='/' className='font-semibold mr-4'>
            <li>Portfolio</li>
        </HashLink>
        ...
        <div className="navbar bg-[#0a192f] text-[#12eac3] border-b-2">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        tabIndex={0}
                        className="menu menu-sm dropdown-content bg-[#0a192f] rounded-box z-[1] mt-3 w-52 p-2 shadow">
                        {
                            navLink
                        }
                    </ul>
            ...
            <div className="navbar-end">
                <HashLink smooth to='#contact' className='px-8 py-3 font-semibold border rounded dark:border-[#12eac3] dark:text-[#12eac3]  mr-4 hover:dark:border-[#ccd6f6] hover:dark:text-[#ccd6f6]'>
                    <p>Hire Me</p>
                </HashLink>
            </div>
        </div>
